    ...
    systems: [
        {
            ...
            planets: [
                ...
                {name: 'saturn', radius: 2.2, color: 0xeeea21, rotation: 0.01, orbitRotation: 0.0017 ,orbitRadius: 40, orbitSkew: 0.1, skew: 0, tags: ['earthlike', 'test'], satelite:[]},
                ...
                {name: 'neptun', radius: 1.1, color: 0x263Cee, rotation: 0.01, orbitRotation: 0.0008 ,orbitRadius: 80, orbitSkew: 0.1, skew: 0, tags: ['earthlike', 'test'], satelite:[]},
